...
SECRET_KEY = 'django-insecure-d!tu6^h9u6v*-a3bq(l#po0@jj0ra0q14c&*!=nn**j3mm*fsd'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'registration.context_processors.user_role',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'USER': 'root', # This is the default MySQL user, replace if necessary
        'PASSWORD': 'CEN4010_Baire', # Replace with your actual password
